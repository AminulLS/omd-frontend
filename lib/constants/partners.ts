...
function generatePartners(): Partner[] {
  ...
  return Array.from({ length: 150 }, (_, i) => {
    ...
    const products = i === 0 ? (["sponsored", "xml", "publisher", "syndication"] as ProductType[]) : randomProducts(rng);
...
export const partnersData: Record<string, Partner> = initialPartners.reduce((acc, partner) => {
